...
# CI/CD Infrastructure removed - using GitHub Actions + ECR events + CodeDeploy
# GitHub Actions will build and push to ECR, triggering CodeDeploy for blue-green deployments
...
# CodeStar connection removed - using GitHub Actions instead

# S3 bucket removed - no artifacts needed with GitHub Actions + CodeBuild approach
...
# CodePipeline removed - using GitHub Actions + CodeBuild + CodeDeploy directly
